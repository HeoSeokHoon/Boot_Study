														...
														<form:form cssClass="user" modelAttribute="memberVO">
															<div class="form-group">
																<form:input path="username"
																	cssClass="form-control form-control-user" id="username"></form:input>
															...
															<div class="form-group">
																<form:input path="phone"
																	cssClass="form-control form-control-user" id="phone"></form:input>
																<form:errors path="phone"></form:errors>

															</div>
															<div class="form-group">
																<form:input path="email"
																	cssClass="form-control form-control-user" id="email"></form:input>
																<form:errors path="email"></form:errors>
															</div>
															<div class="form-group">
																<form:input path="address"
																	cssClass="form-control form-control-user" id="address"></form:input>
																<form:errors path="address"></form:errors>

															</div>
															<div class="form-group">
																<form:input path="name"
																	cssClass="form-control form-control-user" id="name"></form:input>
